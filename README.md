...
| 平台 | 登录方式 | 发布模式 | 状态 |
|------|---------|---------|------|
| 抖音 | 扫码登录 | API 直调 / 浏览器自动化 | ✅ API 模式已通 |
| 小红书 | 扫码登录 | API 直调 / 浏览器自动化 | ✅ API 模式已通 |
| 微信视频号 | 扫码登录 | API 直调 / 浏览器自动化 | ✅ API 模式已通 |
| 快手 | 扫码登录 | API 直调 / 浏览器自动化 | ✅ API 模式已通 |
...
- [x] **快手 API 直调发布**（分片上传 + __NS_sig3 签名 + submit 提交）
- [x] **抖音 API 直调发布**（VOD 上传 + a_bogus 签名）
- [x] **小红书 API 直调发布**（视频上传 + X-s/X-t 签名）
